...
public class ImageViewPagerHideAdapter extends RecyclerView.Adapter<ImageViewPagerHideAdapter.ViewHolder> {
    private ArrayList<Image> images;
    private Context context;

    public ImageViewPagerHideAdapter(Context context, ArrayList<Image> images){
